(function() {
  var checker, iframes, init, resolutions, styleeditor_textarea, tabs, target, top, topDoneClicked, topEditmodeClicked, top_editmode, updateFrameSize;
  ...
  init = function(event) {
    ...
    CodeMirror.fromTextArea(styleeditor_textarea, {
      mode: "css",
      lineNumbers: true
    });
